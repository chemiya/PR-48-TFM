...
# para cada liga y temporada, para cada partido se procesan los indicadores de los equipos
for liga in ligas:
    for temporada in temporadas:
        ...
        partidos_anteriores = pd.DataFrame(columns=partidos.columns)
        ...
        #recorremos los partidos cogiendo solo los previos
        for index, row in partidos.iterrows():
                    ...
                    partidos_anteriores=partidos.iloc[0:index]
                    ...
                    if finalizado==1:
                        ...
                        partidos_local=partidos_anteriores.loc[(partidos_anteriores['id_equipo_local'] == id_equipo_local)  ]
                        ...
                        #datos_partidos_jugados_local_como_local.to_csv('csv/localLocal.csv', index=False) 
                        ...
                        partidos_visitante=partidos_anteriores.loc[(partidos_anteriores['id_equipo_visitante'] == id_equipo_visitante)  ]
                        ...
                        #datos_partidos_jugados_visitante_como_visitante.to_csv('csv/visitanteVisitante.csv', index=False)
                        ...
                        partidos_local=partidos_anteriores.loc[(partidos_anteriores['id_equipo_visitante'] == id_equipo_local)  ]
                        id_partidos_local = partidos_local['id_partido']
                        ...
                        #datos_partidos_jugados_local_como_visitante.to_csv('csv/localVisitante.csv', index=False)
                        ...
                        partidos_visitante=partidos_anteriores.loc[(partidos_anteriores['id_equipo_local'] == id_equipo_visitante)  ]
                        id_partidos_visitante = partidos_visitante['id_partido']
                        ...
                        #datos_partidos_jugados_visitante_como_local.to_csv('csv/visitanteLocal.csv', index=False)
                        ...
                        if contador_local_partidos[0]==0:
                            contador_local_partidos[0]=-1

                        if contador_local_partidos[1]==0:
                            contador_local_partidos[1]=-1

                        if contador_visitante_partidos[0]==0:
                            contador_visitante_partidos[0]=-1

                        if contador_visitante_partidos[1]==0:
                            contador_visitante_partidos[1]=-1
                        ...
                        proporcion_visitante_goles_totales[0]=calculosSin100(contador_visitante_goles_totales[0],contador_visitante_partidos[0])
                        ...
                        media_local_cambio_minutos[0]=0
                        media_local_cambio_minutos[1]=0
                        contador_local_cambios_alineacion_defensa[0]=0
                        contador_local_cambios_alineacion_defensa[1]=0
                        contador_local_cambios_alineacion_centrocampista[0]=0
                        contador_local_cambios_alineacion_centrocampista[1]=0
                        contador_local_cambios_alineacion_delantero[0]=0
                        contador_local_cambios_alineacion_delantero[1]=0
                        ...
                        media_visitante_cambio_minutos[0]=0
                        media_visitante_cambio_minutos[1]=0

                        contador_visitante_cambios_alineacion_defensa[0]=0
                        contador_visitante_cambios_alineacion_defensa[1]=0
                        contador_visitante_cambios_alineacion_centrocampista[0]=0
                        contador_visitante_cambios_alineacion_centrocampista[1]=0
                        contador_visitante_cambios_alineacion_delantero[0]=0
                        contador_visitante_cambios_alineacion_delantero[1]=0
                        ...
                        elemento_insertar = [0 if x < 0 else x for x in elemento_insertar]

                        dataframe_indicadores_equipos_prepartido.loc[len(dataframe_indicadores_equipos_prepartido)]=elemento_insertar
        ...
        if partidos_existen==False:
            # guardamos los datos de los indicadores para cada partido en una liga y temporada
            dataframe_indicadores_equipos_prepartido.to_csv('csv/indicadoresEquipoHistorico-'+liga+'-'+str(temporada)+'.csv', index=False) 
            # vaciamos
            dataframe_indicadores_equipos_prepartido = dataframe_indicadores_equipos_prepartido.drop(dataframe_indicadores_equipos_prepartido.index) 
        else:
            # guardamos los datos de los indicadores para cada partido en una liga y temporada
            dataframe_indicadores_equipos_prepartido.to_csv('csv/indicadoresEquipoHistorico-'+liga+'-'+str(temporada)+'.csv',mode='a', index=False) 
            # vaciamos
            dataframe_indicadores_equipos_prepartido = dataframe_indicadores_equipos_prepartido.drop(dataframe_indicadores_equipos_prepartido.index) 
