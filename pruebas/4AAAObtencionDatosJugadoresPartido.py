...
dataframe_datos_jugadores_partidos.to_csv('csv/datosJugadoresPartidos.csv', index=False)   
dataframe_nuevos_jugadores.to_csv('csv/jugadores.csv', mode='a', header=False, index=False)         